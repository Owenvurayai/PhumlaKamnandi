...
namespace PhumlaKamnandi.Business
{
    public class Room
    {
        ...
        {
            if (RoomType.Single.ToString().Equals(roomTypeStr))
                return RoomType.Single;
            else if (RoomType.Double.ToString().Equals(roomTypeStr))
                return RoomType.Double;
            else if (RoomType.Suite.ToString().Equals(roomTypeStr))
        ...
        {
            if (OccupancyStatus.Availaible.ToString().Equals(status))
                return OccupancyStatus.Availaible;
